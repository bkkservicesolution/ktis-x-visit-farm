  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        "รายชื่อชาวไร่: ถามหลายประเด็นในประโยคเดียว (เช่น วัชพืชไม่ได้ และ หญ้ารก และ ขาดน้ำ) = ต้องตรงครบทุกประเด็น (AND)",
        "- ปุ๋ย: 18/21/27 | น้ำ: 10–15,14 | จัดการวัชพืชไม่ได้: 3–4 | หญ้ารก: 3 | วัชพืชทั่วไป: 3–5 | โรค: 6–7 | ศัตรู: 8–9",
      ].join("\n"),
    },
    {
