...
export function getAdminAiDomainSystemPrompt(): string {
  return [
    ...
    "ข้อมูลตัวเลขจากแบบสำรวมชาวไร่: อิงเฉพาะบล็อก context ที่ค้นหาได้จาก RAG เท่านั้น ห้ามแต่งตัวเลข",
    "ข้อมูลสรุปการเก็บเกี่ยวปี 2568-2569: ใช้จาก data/harvest-stats-2568-2569.json (นำเข้าจาก Excel) ไม่ใช่จากแบบสำรวม Heart4Rooms",
...
export function buildAdminAiDomainKnowledgeChunks(): DomainKnowledgeChunk[] {
  return [
    ...
    },
    {
      ...
      title: "หัวใจ 4 ห้อง และแบบสำรวม Heart4Rooms",
      content: [
        ...
        "- ปุ๋ย",
        "- การดูแลวัชพืช",
        "ข้อมูลหัวใจ 4 ห้องในระบบนี้ = ข้อมูลการประเมินแปลงโดยนักส่งเสริม (แบบสำรวม Heart4Rooms)",
        "คำถามข้อ 1–38 ในแบบสำรวมสะท้อนการปฏิบัติและความต้องการของชาวไร่ในแต่ละด้าน",
      ].join("\n"),
    },
    {
